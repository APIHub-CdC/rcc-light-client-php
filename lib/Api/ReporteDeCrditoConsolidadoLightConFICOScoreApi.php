...
class ReporteDeCrditoConsolidadoLightConFICOScoreApi
{
    ...
    {
        $returnType = '\RccLight\Client\Model\Consultas';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RccLight\Client\Model\Consultas',
    ...
    {
        $returnType = '\RccLight\Client\Model\Creditos';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RccLight\Client\Model\Creditos',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\RccLight\Client\Model\Domicilios';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RccLight\Client\Model\Domicilios',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\RccLight\Client\Model\Empleos';
    ...
    public function getReporte($x_api_key, $username, $password, $body, $x_full_report = 'false')
    {
        list($response) = $this->getReporteWithHttpInfo($x_api_key, $username, $password, $body, $x_full_report);
        return $response;
    }
    
    public function getReporteWithHttpInfo($x_api_key, $username, $password, $body, $x_full_report = 'false')
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RccLight\Client\Model\Respuesta',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\RccLight\Client\Model\Scores';
