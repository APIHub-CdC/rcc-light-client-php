...
class PersonaPLD implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    
    protected static $apihubModelName = 'PersonaPLD';
    ...
    {
        $invalidProperties = [];
        if (!is_null($this->container['nombre']) && (mb_strlen($this->container['nombre']) > 30)) {
            $invalidProperties[] = "invalid value for 'nombre', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['dependencia']) && (mb_strlen($this->container['dependencia']) > 30)) {
            $invalidProperties[] = "invalid value for 'dependencia', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['dispocisiones_id']) && (mb_strlen($this->container['dispocisiones_id']) > 30)) {
            $invalidProperties[] = "invalid value for 'dispocisiones_id', the character length must be smaller than or equal to 30.";
        }
        ...
        if (!is_null($this->container['curp_ok']) && (mb_strlen($this->container['curp_ok']) > 1)) {
            $invalidProperties[] = "invalid value for 'curp_ok', the character length must be smaller than or equal to 1.";
        }
        if (!is_null($this->container['curp_ok']) && (mb_strlen($this->container['curp_ok']) < 0)) {
            $invalidProperties[] = "invalid value for 'curp_ok', the character length must be bigger than or equal to 0.";
        }
    ...
    {
        if (!is_null($nombre) && (mb_strlen($nombre) > 30)) {
            throw new \InvalidArgumentException('invalid length for $nombre when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($nombre) && (mb_strlen($nombre) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nombre when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setApellidoPaterno($apellido_paterno)
    {
        if (!is_null($apellido_paterno) && (mb_strlen($apellido_paterno) > 30)) {
            throw new \InvalidArgumentException('invalid length for $apellido_paterno when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($apellido_paterno) && (mb_strlen($apellido_paterno) < 0)) {
            throw new \InvalidArgumentException('invalid length for $apellido_paterno when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setApellidoMaterno($apellido_materno)
    {
        if (!is_null($apellido_materno) && (mb_strlen($apellido_materno) > 30)) {
            throw new \InvalidArgumentException('invalid length for $apellido_materno when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($apellido_materno) && (mb_strlen($apellido_materno) < 0)) {
            throw new \InvalidArgumentException('invalid length for $apellido_materno when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setRfc($rfc)
    {
        if (!is_null($rfc) && (!preg_match("/^([A-ZÑ,&amp;]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})?$/", $rfc))) {
            throw new \InvalidArgumentException("invalid value for $rfc when calling PersonaPLD., must conform to the pattern /^([A-ZÑ,&amp;]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})?$/.");
        }
    ...
    public function setCurp($curp)
    {
        if (!is_null($curp) && (!preg_match("/^([A-Z][AEIOUX][A-Z]{2}\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])[HM](?:AS|B[CS]|C[CLMSH]|D[FG]|G[TR]|HG|JC|M[CNS]|N[ETL]|OC|PL|Q[TR]|S[PLR]|T[CSL]|VZ|YN|ZS)[B-DF-HJ-NP-TV-Z]{3}[A-Z\d])(\d)$/", $curp))) {
            throw new \InvalidArgumentException("invalid value for $curp when calling PersonaPLD., must conform to the pattern /^([A-Z][AEIOUX][A-Z]{2}\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\d|3[01])[HM](?:AS|B[CS]|C[CLMSH]|D[FG]|G[TR]|HG|JC|M[CNS]|N[ETL]|OC|PL|Q[TR]|S[PLR]|T[CSL]|VZ|YN|ZS)[B-DF-HJ-NP-TV-Z]{3}[A-Z\d])(\d)$/.");
        }
    ...
    public function setLista($lista)
    {
        if (!is_null($lista) && (mb_strlen($lista) > 30)) {
            throw new \InvalidArgumentException('invalid length for $lista when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($lista) && (mb_strlen($lista) < 0)) {
            throw new \InvalidArgumentException('invalid length for $lista when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setEstatus($estatus)
    {
        if (!is_null($estatus) && (mb_strlen($estatus) > 30)) {
            throw new \InvalidArgumentException('invalid length for $estatus when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($estatus) && (mb_strlen($estatus) < 0)) {
            throw new \InvalidArgumentException('invalid length for $estatus when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    {
        if (!is_null($dependencia) && (mb_strlen($dependencia) > 30)) {
            throw new \InvalidArgumentException('invalid length for $dependencia when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($dependencia) && (mb_strlen($dependencia) < 0)) {
            throw new \InvalidArgumentException('invalid length for $dependencia when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    {
        if (!is_null($dispocisiones_id) && (mb_strlen($dispocisiones_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $dispocisiones_id when calling PersonaPLD., must be smaller than or equal to 30.');
        }
        if (!is_null($dispocisiones_id) && (mb_strlen($dispocisiones_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $dispocisiones_id when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    {
        if (!is_null($curp_ok) && (mb_strlen($curp_ok) > 1)) {
            throw new \InvalidArgumentException('invalid length for $curp_ok when calling PersonaPLD., must be smaller than or equal to 1.');
        }
        if (!is_null($curp_ok) && (mb_strlen($curp_ok) < 0)) {
            throw new \InvalidArgumentException('invalid length for $curp_ok when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setRazonSocial($razon_social)
    {
        if (!is_null($razon_social) && (mb_strlen($razon_social) > 6)) {
            throw new \InvalidArgumentException('invalid length for $razon_social when calling PersonaPLD., must be smaller than or equal to 6.');
        }
        if (!is_null($razon_social) && (mb_strlen($razon_social) < 5)) {
            throw new \InvalidArgumentException('invalid length for $razon_social when calling PersonaPLD., must be bigger than or equal to 5.');
        }
    ...
    public function setRfcMoral($rfc_moral)
    {
        if (!is_null($rfc_moral) && (!preg_match("/^([A-ZÑ,&amp;]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})?$/", $rfc_moral))) {
            throw new \InvalidArgumentException("invalid value for $rfc_moral when calling PersonaPLD., must conform to the pattern /^([A-ZÑ,&amp;]{3,4}([0-9]{2})(0[1-9]|1[0-2])(0[1-9]|1[0-9]|2[0-9]|3[0-1]))([A-Z\d]{3})?$/.");
        }
    ...
    public function setNombreCompleto($nombre_completo)
    {
        if (!is_null($nombre_completo) && (mb_strlen($nombre_completo) > 90)) {
            throw new \InvalidArgumentException('invalid length for $nombre_completo when calling PersonaPLD., must be smaller than or equal to 90.');
        }
        if (!is_null($nombre_completo) && (mb_strlen($nombre_completo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nombre_completo when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setApellidos($apellidos)
    {
        if (!is_null($apellidos) && (mb_strlen($apellidos) > 60)) {
            throw new \InvalidArgumentException('invalid length for $apellidos when calling PersonaPLD., must be smaller than or equal to 60.');
        }
        if (!is_null($apellidos) && (mb_strlen($apellidos) < 0)) {
            throw new \InvalidArgumentException('invalid length for $apellidos when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setSexo($sexo)
    {
        if (!is_null($sexo) && (mb_strlen($sexo) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sexo when calling PersonaPLD., must be smaller than or equal to 10.');
        }
        if (!is_null($sexo) && (mb_strlen($sexo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $sexo when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setArea($area)
    {
        if (!is_null($area) && (mb_strlen($area) > 60)) {
            throw new \InvalidArgumentException('invalid length for $area when calling PersonaPLD., must be smaller than or equal to 60.');
        }
        if (!is_null($area) && (mb_strlen($area) < 0)) {
            throw new \InvalidArgumentException('invalid length for $area when calling PersonaPLD., must be bigger than or equal to 0.');
        }
    ...
    public function setPeriodo($periodo)
    {
        if (!is_null($periodo) && (mb_strlen($periodo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $periodo when calling PersonaPLD., must be bigger than or equal to 0.');
        }
