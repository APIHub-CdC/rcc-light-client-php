...
class PersonaPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'nacionalidad' => 'string',
        'residencia' => '\RccLight\Client\Model\CatalogoResidencia',
        'estado_civil' => '\RccLight\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\RccLight\Client\Model\CatalogoSexo',
        'clave_elector' => 'string',
        'numero_dependientes' => 'string',
        'fecha_defuncion' => 'string',
        'domicilio' => '\RccLight\Client\Model\Domicilio'
    ];
