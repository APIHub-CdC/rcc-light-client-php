...
class Empleo implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\RccLight\Client\Model\CatalogoEstados',
        'cp' => 'string',
        ...
        'clave_moneda' => '\RccLight\Client\Model\CatalogoMoneda',
        'salario_mensual' => 'int',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['extension']) && (mb_strlen($this->container['extension']) > 20)) {
            $invalidProperties[] = "invalid value for 'extension', the character length must be smaller than or equal to 20.";
        }
    ...
    {
        if (!is_null($extension) && (mb_strlen($extension) > 20)) {
            throw new \InvalidArgumentException('invalid length for $extension when calling Empleo., must be smaller than or equal to 20.');
        }
