...
namespace RccLight\Client\Interceptor;
...
use \RccLight\Client\Interceptor\KeyHandler;
use \RccLight\Client\Interceptor\MyLogger;
use \RccLight\Client\Model\Errors;
use \RccLight\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\RccLight\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \RccLight\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \RccLight\Client\Model\Errores(["errors" => [$error]]);
